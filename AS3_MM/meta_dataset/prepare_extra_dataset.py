import os
import sys
sys.path.append('/mfs/xxzhang/meta-dataset/Data_download/')

from data import learning_spec
from dataset_conversion.dataset_to_records import DatasetConverter, write_tfrecord_from_directory
...
def main():
    ...
    datasrc_path = '/mfs/xxzhang/meta-dataset/Data_download/'
    records_path = '/mfs/xxzhang/meta-dataset/RECORDS'
    splits_path  = '/mfs/xxzhang/meta-dataset/SPLITS'
