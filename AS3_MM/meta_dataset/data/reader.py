...
def episode_representation_generator(dataset_spec, split, pool, sampler):
  ...
  * some number of additional chunks (for example, a "support" chunk and a
  ...
  dataset_spec_dict = dataset_spec.to_dict()
  class_set = dataset_spec.get_classes(split,dataset_spec_dict)
...
class Reader(object):
  ...
  def __init__(self,
    ...
    dataset_spec_dict = dataset_spec.to_dict()
    self.class_set = self.dataset_spec.get_classes(self.split,dataset_spec_dict)
