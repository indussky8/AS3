...
# data args
parser.add_argument('--data.train', type=str, default='omniglot', metavar='TRAINSETS', nargs='+', help="Datasets for training extractors")
parser.add_argument('--data.val', type=str, default='', metavar='VALSETS', nargs='+',
                    help="Datasets used for validation")
parser.add_argument('--data.test', type=str, default='', metavar='TESTSETS', nargs='+',
                    help="Datasets used for testing")
parser.add_argument('--data.trgset', type=str, default='cu_birds', metavar='TESTSETS', nargs='+',
                    help="Datasets used for testing")
parser.add_argument('--data.dataspec_root_dir', type=str, default='',
                    help="Number of workers that pre-process images in parallel")
parser.add_argument('--data.novel_class_save_dir', type=str, default='../novel_class_dict/',
                    help="Number of workers that pre-process images in parallel")
...
parser.add_argument('--model.backbone', default='resnet18_sel', help="Use ResNet18 for experiments (default: False)")
...
parser.add_argument('--model.save_dir', type=str, default='./save_model/bert_center_fea_based_on_task_10.0_0.1/number_based_500/', help="Adding dropout inside a basic block of widenet")
...
parser.add_argument('--train.resume', type=int, default=0, metavar='RESUME_TRAIN',
